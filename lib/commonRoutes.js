...
FlowRouter.route('/privacy-policy', {
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('currentuser'),
                    Meteor.subscribe('area'),
                    Meteor.subscribe('generalContentUrl','privacy-policy'),                               
                ];   
...
FlowRouter.route('/terms-of-service', {
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('currentuser'),
                    Meteor.subscribe('area'),
                    Meteor.subscribe('generalContentUrl','terms-of-service'),               
                ];   
    },
    action: function() {
...
FlowRouter.route('/code-of-conduct', {
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('currentuser'),
                    Meteor.subscribe('area'),
                    Meteor.subscribe('generalContentUrl','code-of-conduct'),              
                ];   
    },
    action: function() {
...
FlowRouter.route('/merchant-guidelines', {
    waitOn(params) { 
        ...
        return [ 
                    ...
                    Meteor.subscribe('currentuser'),
                    Meteor.subscribe('area'),
                    Meteor.subscribe('generalContentUrl','merchant-guidelines'),     
                ];   
    },  
    action: function() {
