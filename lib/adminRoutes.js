...
FlowRouter.route('/adminDashboard', {
    ...
    waitOn(params) {        
        return [ 
                    ...
                    Meteor.subscribe('noOfBanner'),
                    Meteor.subscribe('noOfAds'),
                    Meteor.subscribe('noOfOffer'),
                    Meteor.subscribe('noOfEnq'),
...
FlowRouter.route('/OfferSaleReport', {
    name: 'offerSalesReport',
    waitOn(params) {        
        var type = 'Offer';
        return [ 
                    Meteor.subscribe('contactUs'),  
                    ...
                    Meteor.subscribe('notificationTemplate') ,
                    Meteor.subscribe('notification'),
                    Meteor.subscribe('offerPayment',type),
                    Meteor.subscribe('noOfInvoiceCount'),  
